...
if [ -z "${GIT_REPO}"  ]; then
    ...
    if [ -z ${GIT_CREDENTIALS} ]; then
        ...
        # Clone an Azure DevOps/Github private repo using the Generate Git Credentials option
        # Format of GIT_CREDENTIALS should be username:password generated by Azure DevOps/format provided by github for SSH/GPG keys
